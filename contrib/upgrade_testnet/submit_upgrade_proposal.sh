...
TX_FLAGS="--from node0 --keyring-backend test --home ./build/node0/mage --chain-id $CHAIN_ID --yes --fees 100ughost"
...
mage tx gov deposit $PROPOSAL_ID 10000000ughost $TX_FLAGS >/dev/null 2>&1
