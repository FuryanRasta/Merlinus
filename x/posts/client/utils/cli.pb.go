...
// source: mage/posts/v2/client/cli.proto
...
import (
	...
	types "github.com/warmage-sports/mage/x/posts/types"
...
type CreatePostJSON struct {
	...
	ReplySettings types.ReplySetting `protobuf:"varint,7,opt,name=reply_settings,json=replySettings,proto3,enum=mage.posts.v2.ReplySetting" json:"reply_settings,omitempty"`
...
func init() {
	proto.RegisterType((*CreatePostJSON)(nil), "mage.posts.v2.client.CreatePostJSON")
	proto.RegisterType((*EditPostJSON)(nil), "mage.posts.v2.client.EditPostJSON")
}

func init() { proto.RegisterFile("mage/posts/v2/client/cli.proto", fileDescriptor_d5899b795c71461f) }
