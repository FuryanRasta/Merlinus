...
func TestMsgEditPost_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgEditPost","value":{"editor":"cosmos13t6y2nnugtshwuy0zkrq287a95lyy8vzleaxmd","entities":{"hashtags":[{"end":"3","start":"1","tag":"tag"}],"mentions":[{"end":"6","start":"4","tag":"tag"}],"urls":[{"display_url":"Display URL","end":"9","start":"7","url":"URL"}]},"post_id":"1","subspace_id":"1","tags":["general"],"text":"Edited text"}}`
...
func TestMsgAddPostAttachment_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAddPostAttachment","value":{"content":{"type":"mage/Media","value":{"mime_type":"image/png","uri":"ftp://user:password@example.com/image.png"}},"editor":"cosmos13t6y2nnugtshwuy0zkrq287a95lyy8vzleaxmd","post_id":"1","subspace_id":"1"}}`
...
func TestMsgRemovePostAttachment_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRemovePostAttachment","value":{"attachment_id":1,"editor":"cosmos13t6y2nnugtshwuy0zkrq287a95lyy8vzleaxmd","post_id":"1","subspace_id":"1"}}`
...
func TestMsgDeletePost_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgDeletePost","value":{"post_id":"1","signer":"cosmos13t6y2nnugtshwuy0zkrq287a95lyy8vzleaxmd","subspace_id":"1"}}`
...
func TestMsgAnswerPoll_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAnswerPoll","value":{"answers_indexes":[1,2,3],"poll_id":1,"post_id":"1","signer":"cosmos13t6y2nnugtshwuy0zkrq287a95lyy8vzleaxmd","subspace_id":"1"}}`
