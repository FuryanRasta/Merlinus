...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/relationships/v1/msg_server.proto#L27-L39
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/relationships/v1/msg_server.proto#L47-L56
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/relationships/v1/msg_server.proto#L64-L74
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/relationships/v1/msg_server.proto#L81-L89
```
