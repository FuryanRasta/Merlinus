...
%s query relationships relationships 1 mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud
%s query relationships relationships 1 mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud mage159axlj0mkvch02f95t5tkghychyeueaslk6r8f`,
...
%s query relationships blocks 1 mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud
%s query relationships blocks 1 mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud mage159axlj0mkvch02f95t5tkghychyeueaslk6r8f`,
			version.AppName, version.AppName, version.AppName),
		Args: cobra.RangeArgs(1, 3),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
