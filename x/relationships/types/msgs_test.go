...
func TestMsgCreateRelationship_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgCreateRelationship","value":{"counterparty":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","signer":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","subspace_id":"1"}}`
...
func TestMsgDeleteRelationships_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgDeleteRelationship","value":{"counterparty":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","signer":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","subspace_id":"1"}}`
...
func TestMsgBlockUser_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgBlockUser","value":{"blocked":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","blocker":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","reason":"reason"}}`
...
func TestMsgUnblockUser_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgUnblockUser","value":{"blocked":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","blocker":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns"}}`
