...
// source: mage/relationships/v1/msgs.proto
...
func init() {
	proto.RegisterType((*MsgCreateRelationship)(nil), "mage.relationships.v1.MsgCreateRelationship")
	proto.RegisterType((*MsgCreateRelationshipResponse)(nil), "mage.relationships.v1.MsgCreateRelationshipResponse")
	proto.RegisterType((*MsgDeleteRelationship)(nil), "mage.relationships.v1.MsgDeleteRelationship")
	proto.RegisterType((*MsgDeleteRelationshipResponse)(nil), "mage.relationships.v1.MsgDeleteRelationshipResponse")
	proto.RegisterType((*MsgBlockUser)(nil), "mage.relationships.v1.MsgBlockUser")
	proto.RegisterType((*MsgBlockUserResponse)(nil), "mage.relationships.v1.MsgBlockUserResponse")
	proto.RegisterType((*MsgUnblockUser)(nil), "mage.relationships.v1.MsgUnblockUser")
	proto.RegisterType((*MsgUnblockUserResponse)(nil), "mage.relationships.v1.MsgUnblockUserResponse")
}

func init() {
	proto.RegisterFile("mage/relationships/v1/msgs.proto", fileDescriptor_96a11e032a59b620)
}
...
func (c *msgClient) CreateRelationship(ctx context.Context, in *MsgCreateRelationship, opts ...grpc.CallOption) (*MsgCreateRelationshipResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Msg/CreateRelationship", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteRelationship(ctx context.Context, in *MsgDeleteRelationship, opts ...grpc.CallOption) (*MsgDeleteRelationshipResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Msg/DeleteRelationship", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BlockUser(ctx context.Context, in *MsgBlockUser, opts ...grpc.CallOption) (*MsgBlockUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Msg/BlockUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UnblockUser(ctx context.Context, in *MsgUnblockUser, opts ...grpc.CallOption) (*MsgUnblockUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Msg/UnblockUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Msg/CreateRelationship",
	}
...
func _Msg_DeleteRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Msg/DeleteRelationship",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BlockUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Msg/BlockUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UnblockUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Msg/UnblockUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.relationships.v1.Msg",
	...
	Metadata: "mage/relationships/v1/msgs.proto",
}
