...
// source: mage/relationships/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryRelationshipsRequest)(nil), "mage.relationships.v1.QueryRelationshipsRequest")
	proto.RegisterType((*QueryRelationshipsResponse)(nil), "mage.relationships.v1.QueryRelationshipsResponse")
	proto.RegisterType((*QueryBlocksRequest)(nil), "mage.relationships.v1.QueryBlocksRequest")
	proto.RegisterType((*QueryBlocksResponse)(nil), "mage.relationships.v1.QueryBlocksResponse")
}

func init() {
	proto.RegisterFile("mage/relationships/v1/query.proto", fileDescriptor_10005dbd2b21ca8c)
}
...
func (c *queryClient) Relationships(ctx context.Context, in *QueryRelationshipsRequest, opts ...grpc.CallOption) (*QueryRelationshipsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Query/Relationships", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Blocks(ctx context.Context, in *QueryBlocksRequest, opts ...grpc.CallOption) (*QueryBlocksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.relationships.v1.Query/Blocks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Relationships_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Query/Relationships",
	}
...
func _Query_Blocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.relationships.v1.Query/Blocks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.relationships.v1.Query",
	...
	Metadata: "mage/relationships/v1/query.proto",
}
