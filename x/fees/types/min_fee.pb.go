...
// source: mage/fees/v1/min_fee.proto
...
func init() {
	proto.RegisterType((*MinFee)(nil), "mage.fees.v1.MinFee")
}

func init() { proto.RegisterFile("mage/fees/v1/min_fee.proto", fileDescriptor_8b8693026f592aa5) }
