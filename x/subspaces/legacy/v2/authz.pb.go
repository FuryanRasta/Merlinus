...
// source: mage/subspaces/v2/authz/authz.proto
...
func init() {
	proto.RegisterType((*GenericSubspaceAuthorization)(nil), "mage.subspaces.v2.authz.GenericSubspaceAuthorization")
}

func init() {
	proto.RegisterFile("mage/subspaces/v2/authz/authz.proto", fileDescriptor_21914b81942bd86e)
}
