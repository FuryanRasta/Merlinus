...
// source: mage/subspaces/v3/authz/authz.proto
...
func init() {
	proto.RegisterType((*GenericSubspaceAuthorization)(nil), "mage.subspaces.v3.authz.GenericSubspaceAuthorization")
}

func init() {
	proto.RegisterFile("mage/subspaces/v3/authz/authz.proto", fileDescriptor_a9e0e1d4a7397c6c)
}
