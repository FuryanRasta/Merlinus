...
func TestMsgCreateReport_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgCreateReport","value":{"message":"This post is spam","reasons_ids":[1],"reporter":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","subspace_id":"1","target":{"type":"mage/PostTarget","value":{"post_id":"1"}}}}`
...
func TestMsgDeleteReport_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgDeleteReport","value":{"report_id":"1","signer":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","subspace_id":"1"}}`
...
func TestMsgSupportStandardReason_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgSupportStandardReason","value":{"signer":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","standard_reason_id":1,"subspace_id":"1"}}`
...
func TestMsgAddReason_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAddReason","value":{"description":"This post is spam or the user is a spammer","signer":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","subspace_id":"1","title":"Spam"}}`
...
func TestMsgRemoveReason_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRemoveReason","value":{"reason_id":1,"signer":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","subspace_id":"1"}}`
