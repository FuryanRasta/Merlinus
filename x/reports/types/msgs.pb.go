...
// source: mage/reports/v1/msgs.proto
...
func init() {
	proto.RegisterType((*MsgCreateReport)(nil), "mage.reports.v1.MsgCreateReport")
	proto.RegisterType((*MsgCreateReportResponse)(nil), "mage.reports.v1.MsgCreateReportResponse")
	proto.RegisterType((*MsgDeleteReport)(nil), "mage.reports.v1.MsgDeleteReport")
	proto.RegisterType((*MsgDeleteReportResponse)(nil), "mage.reports.v1.MsgDeleteReportResponse")
	proto.RegisterType((*MsgSupportStandardReason)(nil), "mage.reports.v1.MsgSupportStandardReason")
	proto.RegisterType((*MsgSupportStandardReasonResponse)(nil), "mage.reports.v1.MsgSupportStandardReasonResponse")
	proto.RegisterType((*MsgAddReason)(nil), "mage.reports.v1.MsgAddReason")
	proto.RegisterType((*MsgAddReasonResponse)(nil), "mage.reports.v1.MsgAddReasonResponse")
	proto.RegisterType((*MsgRemoveReason)(nil), "mage.reports.v1.MsgRemoveReason")
	proto.RegisterType((*MsgRemoveReasonResponse)(nil), "mage.reports.v1.MsgRemoveReasonResponse")
}

func init() { proto.RegisterFile("mage/reports/v1/msgs.proto", fileDescriptor_c7165cc8d939a535) }
...
func (c *msgClient) CreateReport(ctx context.Context, in *MsgCreateReport, opts ...grpc.CallOption) (*MsgCreateReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.reports.v1.Msg/CreateReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteReport(ctx context.Context, in *MsgDeleteReport, opts ...grpc.CallOption) (*MsgDeleteReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.reports.v1.Msg/DeleteReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SupportStandardReason(ctx context.Context, in *MsgSupportStandardReason, opts ...grpc.CallOption) (*MsgSupportStandardReasonResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.reports.v1.Msg/SupportStandardReason", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddReason(ctx context.Context, in *MsgAddReason, opts ...grpc.CallOption) (*MsgAddReasonResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.reports.v1.Msg/AddReason", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveReason(ctx context.Context, in *MsgRemoveReason, opts ...grpc.CallOption) (*MsgRemoveReasonResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.reports.v1.Msg/RemoveReason", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.reports.v1.Msg/CreateReport",
	}
...
func _Msg_DeleteReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.reports.v1.Msg/DeleteReport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SupportStandardReason_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.reports.v1.Msg/SupportStandardReason",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AddReason_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.reports.v1.Msg/AddReason",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RemoveReason_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.reports.v1.Msg/RemoveReason",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.reports.v1.Msg",
	...
	Metadata: "mage/reports/v1/msgs.proto",
}
