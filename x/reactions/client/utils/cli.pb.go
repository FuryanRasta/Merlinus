...
// source: mage/reactions/v1/client/cli.proto
...
import (
	...
	types "github.com/mage-war/mage/x/reactions/types"
...
func init() {
	proto.RegisterType((*SetReactionsParamsJSON)(nil), "mage.reactions.v1.client.SetReactionsParamsJSON")
}

func init() {
	proto.RegisterFile("mage/reactions/v1/client/cli.proto", fileDescriptor_aecb29e08714fd3f)
}
