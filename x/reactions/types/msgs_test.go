...
func TestMsgAddReaction_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAddReaction","value":{"post_id":"1","subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc","value":{"type":"mage/RegisteredReactionValue","value":{"registered_reaction_id":1}}}}`
...
func TestMsgRemoveReaction_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRemoveReaction","value":{"post_id":"1","reaction_id":1,"subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc"}}`
...
func TestMsgAddRegisteredReaction_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAddRegisteredReaction","value":{"display_value":"https://example.com?images=hello.png","shorthand_code":":hello:","subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc"}}`
...
func TestMsgEditRegisteredReaction_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgEditRegisteredReaction","value":{"display_value":"https://example.com?images=hello.png","registered_reaction_id":1,"shorthand_code":":hello:","subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc"}}`
...
func TestMsgRemoveRegisteredReaction_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRemoveRegisteredReaction","value":{"registered_reaction_id":1,"subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc"}}`
...
func TestMsgSetReactionsParams_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgSetReactionsParams","value":{"free_text":{"enabled":true,"max_length":100,"reg_ex":"[a-zA-Z]"},"registered_reaction":{"enabled":true},"subspace_id":"1","user":"cosmos1qewk97fp49vzssrfnc997jpztc5nzr7xsd8zdc"}}`
