...
// source: mage/profiles/v3/msgs_app_links.proto
...
type MsgUnlinkApplication struct {
	...
	// Signer represents the Mage account to which the application should be
	// unlinked
...
func init() {
	proto.RegisterType((*MsgLinkApplication)(nil), "mage.profiles.v3.MsgLinkApplication")
	proto.RegisterType((*MsgLinkApplicationResponse)(nil), "mage.profiles.v3.MsgLinkApplicationResponse")
	proto.RegisterType((*MsgUnlinkApplication)(nil), "mage.profiles.v3.MsgUnlinkApplication")
	proto.RegisterType((*MsgUnlinkApplicationResponse)(nil), "mage.profiles.v3.MsgUnlinkApplicationResponse")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/msgs_app_links.proto", fileDescriptor_29dfbdba444598ee)
}
