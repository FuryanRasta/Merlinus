...
// source: mage/profiles/v3/msgs_chain_links.proto
...
type MsgLinkChainAccount struct {
	...
	// Signer represents the Mage address associated with the
...
type MsgUnlinkChainAccount struct {
	// Owner represents the Mage profile from which to remove the link
...
func init() {
	proto.RegisterType((*MsgLinkChainAccount)(nil), "mage.profiles.v3.MsgLinkChainAccount")
	proto.RegisterType((*MsgLinkChainAccountResponse)(nil), "mage.profiles.v3.MsgLinkChainAccountResponse")
	proto.RegisterType((*MsgUnlinkChainAccount)(nil), "mage.profiles.v3.MsgUnlinkChainAccount")
	proto.RegisterType((*MsgUnlinkChainAccountResponse)(nil), "mage.profiles.v3.MsgUnlinkChainAccountResponse")
	proto.RegisterType((*MsgSetDefaultExternalAddress)(nil), "mage.profiles.v3.MsgSetDefaultExternalAddress")
	proto.RegisterType((*MsgSetDefaultExternalAddressResponse)(nil), "mage.profiles.v3.MsgSetDefaultExternalAddressResponse")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/msgs_chain_links.proto", fileDescriptor_52cd1f5b825f2f4e)
}
