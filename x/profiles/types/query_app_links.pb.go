...
// source: mage/profiles/v3/query_app_links.proto
...
type QueryApplicationLinksRequest struct {
	// (Optional) User contains the Mage profile address associated for which
...
func init() {
	proto.RegisterType((*QueryApplicationLinksRequest)(nil), "mage.profiles.v3.QueryApplicationLinksRequest")
	proto.RegisterType((*QueryApplicationLinksResponse)(nil), "mage.profiles.v3.QueryApplicationLinksResponse")
	proto.RegisterType((*QueryApplicationLinkByClientIDRequest)(nil), "mage.profiles.v3.QueryApplicationLinkByClientIDRequest")
	proto.RegisterType((*QueryApplicationLinkByClientIDResponse)(nil), "mage.profiles.v3.QueryApplicationLinkByClientIDResponse")
	proto.RegisterType((*QueryApplicationLinkOwnersRequest)(nil), "mage.profiles.v3.QueryApplicationLinkOwnersRequest")
	proto.RegisterType((*QueryApplicationLinkOwnersResponse)(nil), "mage.profiles.v3.QueryApplicationLinkOwnersResponse")
	proto.RegisterType((*QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails)(nil), "mage.profiles.v3.QueryApplicationLinkOwnersResponse.ApplicationLinkOwnerDetails")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/query_app_links.proto", fileDescriptor_b3b6ad0478f8a288)
}
