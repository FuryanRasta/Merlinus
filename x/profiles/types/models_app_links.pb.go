...
// source: mage/profiles/v3/models_app_links.proto
...
type ApplicationLink struct {
	...
	// State of the link
	State ApplicationLinkState `protobuf:"varint,3,opt,name=state,proto3,enum=mage.profiles.v3.ApplicationLinkState" json:"state,omitempty" yaml:"state"`
...
func init() {
	proto.RegisterEnum("mage.profiles.v3.ApplicationLinkState", ApplicationLinkState_name, ApplicationLinkState_value)
	proto.RegisterType((*ApplicationLink)(nil), "mage.profiles.v3.ApplicationLink")
	proto.RegisterType((*Data)(nil), "mage.profiles.v3.Data")
	proto.RegisterType((*OracleRequest)(nil), "mage.profiles.v3.OracleRequest")
	proto.RegisterType((*OracleRequest_CallData)(nil), "mage.profiles.v3.OracleRequest.CallData")
	proto.RegisterType((*Result)(nil), "mage.profiles.v3.Result")
	proto.RegisterType((*Result_Success)(nil), "mage.profiles.v3.Result.Success")
	proto.RegisterType((*Result_Failed)(nil), "mage.profiles.v3.Result.Failed")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/models_app_links.proto", fileDescriptor_e02d86ea3253bfd9)
}
