...
// source: mage/profiles/v3/models_chain_links.proto
...
type SingleSignature struct {
	...
	ValueType SignatureValueType `protobuf:"varint,1,opt,name=value_type,json=valueType,proto3,enum=mage.profiles.v3.SignatureValueType" json:"value_type,omitempty" yaml:"value_type"`
...
func init() {
	proto.RegisterEnum("mage.profiles.v3.SignatureValueType", SignatureValueType_name, SignatureValueType_value)
	proto.RegisterType((*ChainLink)(nil), "mage.profiles.v3.ChainLink")
	proto.RegisterType((*ChainConfig)(nil), "mage.profiles.v3.ChainConfig")
	proto.RegisterType((*Proof)(nil), "mage.profiles.v3.Proof")
	proto.RegisterType((*Bech32Address)(nil), "mage.profiles.v3.Bech32Address")
	proto.RegisterType((*Base58Address)(nil), "mage.profiles.v3.Base58Address")
	proto.RegisterType((*HexAddress)(nil), "mage.profiles.v3.HexAddress")
	proto.RegisterType((*SingleSignature)(nil), "mage.profiles.v3.SingleSignature")
	proto.RegisterType((*CosmosMultiSignature)(nil), "mage.profiles.v3.CosmosMultiSignature")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/models_chain_links.proto", fileDescriptor_29bee920e792da29)
}
