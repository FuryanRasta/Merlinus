...
func TestMsgLinkApplication_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgLinkApplication","value":{"call_data":"7B22757365726E616D65223A22526963636172646F4D222C22676973745F6964223A223732306530303732333930613930316262383065353966643630643766646564227D","link_data":{"application":"twitter","username":"twitteruser"},"sender":"cosmos10nsdxxdvy9qka3zv0lzw8z9cnu6kanld8jh773","source_channel":"channel-0","source_port":"ibc-profiles","timeout_height":{"revision_height":"1000"}}}`
...
func TestMsgUnlinkApplication_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgUnlinkApplication","value":{"application":"twitter","signer":"cosmos10nsdxxdvy9qka3zv0lzw8z9cnu6kanld8jh773","username":"twitteruser"}}`
