...
func TestUnmarshalSignature(t *testing.T) {
	...
	expectedMemo := "mage16c60y8t8vra27zjg2arlcd58dck9cwn7p6fwtd"
...
func TestValidatePersonalSignValue(t *testing.T) {
	testCases := []struct {
		...
		{
			name:          "correct value returns no error",
			value:         []byte("\x19Ethereum Signed Message:\n45mage16c60y8t8vra27zjg2arlcd58dck9cwn7p6fwtd"),
			expectedValue: "mage16c60y8t8vra27zjg2arlcd58dck9cwn7p6fwtd",
			shouldErr:     false,
		},
	}
...
func TestBech32Address_Validate(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			address:   types.NewBech32Address("mage1tdgrkvx2qgjk0uqsmdhm6dcz6wvwh9f8t37x0k", "cosmos"),
			shouldErr: true,
		},
		{
			name:      "invalid address returns error",
			address:   types.NewBech32Address("mage1tdgrkvx2qgjk0uqsmdhm6dcz6wvwh9f8t37x0", "mage"),
			shouldErr: true,
		},
		{
