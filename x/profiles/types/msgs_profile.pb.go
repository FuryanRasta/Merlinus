...
// source: mage/profiles/v3/msgs_profile.proto
...
func init() {
	proto.RegisterType((*MsgSaveProfile)(nil), "mage.profiles.v3.MsgSaveProfile")
	proto.RegisterType((*MsgSaveProfileResponse)(nil), "mage.profiles.v3.MsgSaveProfileResponse")
	proto.RegisterType((*MsgDeleteProfile)(nil), "mage.profiles.v3.MsgDeleteProfile")
	proto.RegisterType((*MsgDeleteProfileResponse)(nil), "mage.profiles.v3.MsgDeleteProfileResponse")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/msgs_profile.proto", fileDescriptor_5ea75cf4ca5bb3a3)
}
