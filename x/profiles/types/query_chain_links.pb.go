...
// source: mage/profiles/v3/query_chain_links.proto
...
type QueryChainLinksRequest struct {
	// (optional) User represents the Mage address of the user to which search
	// the link for
...
func init() {
	proto.RegisterType((*QueryChainLinksRequest)(nil), "mage.profiles.v3.QueryChainLinksRequest")
	proto.RegisterType((*QueryChainLinksResponse)(nil), "mage.profiles.v3.QueryChainLinksResponse")
	proto.RegisterType((*QueryChainLinkOwnersRequest)(nil), "mage.profiles.v3.QueryChainLinkOwnersRequest")
	proto.RegisterType((*QueryChainLinkOwnersResponse)(nil), "mage.profiles.v3.QueryChainLinkOwnersResponse")
	proto.RegisterType((*QueryChainLinkOwnersResponse_ChainLinkOwnerDetails)(nil), "mage.profiles.v3.QueryChainLinkOwnersResponse.ChainLinkOwnerDetails")
	proto.RegisterType((*QueryDefaultExternalAddressesRequest)(nil), "mage.profiles.v3.QueryDefaultExternalAddressesRequest")
	proto.RegisterType((*QueryDefaultExternalAddressesResponse)(nil), "mage.profiles.v3.QueryDefaultExternalAddressesResponse")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/query_chain_links.proto", fileDescriptor_17ef8689aa5884e9)
}
