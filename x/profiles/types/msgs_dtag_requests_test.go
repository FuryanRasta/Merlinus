...
func TestMsgRequestDTagTransfer_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRequestDTagTransfer","value":{"receiver":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","sender":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns"}}`
...
func TestMsgAcceptDTagTransferRequest_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgAcceptDTagTransferRequest","value":{"new_dtag":"dtag","receiver":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","sender":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47"}}`
...
func TestMsgRejectDTagTransferRequest_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgRefuseDTagTransferRequest","value":{"receiver":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","sender":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47"}}`
...
func TestMsgCancelDTagTransferRequest_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgCancelDTagTransferRequest","value":{"receiver":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","sender":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns"}}`
