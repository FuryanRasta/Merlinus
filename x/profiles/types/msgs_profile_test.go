...
func TestMsgSaveProfile_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgSaveProfile","value":{"bio":"biography","cover_picture":"https://shorturl.at/cgpyF","creator":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns","dtag":"monk","nickname":"nickname","profile_picture":"https://shorturl.at/adnX3"}}`
...
func TestMsgDeleteProfile_GetSignBytes(t *testing.T) {
	expected := `{"type":"mage/MsgDeleteProfile","value":{"creator":"cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns"}}`
