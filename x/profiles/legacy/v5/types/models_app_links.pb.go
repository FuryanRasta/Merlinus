...
// source: mage/profiles/v2/models_app_links.proto
...
type ApplicationLink struct {
	...
	// State of the link
	State ApplicationLinkState `protobuf:"varint,3,opt,name=state,proto3,enum=mage.profiles.v2.ApplicationLinkState" json:"state,omitempty" yaml:"state"`
...
func init() {
	proto.RegisterEnum("mage.profiles.v2.ApplicationLinkState", ApplicationLinkState_name, ApplicationLinkState_value)
	proto.RegisterType((*ApplicationLink)(nil), "mage.profiles.v2.ApplicationLink")
	proto.RegisterType((*Data)(nil), "mage.profiles.v2.Data")
	proto.RegisterType((*OracleRequest)(nil), "mage.profiles.v2.OracleRequest")
	proto.RegisterType((*OracleRequest_CallData)(nil), "mage.profiles.v2.OracleRequest.CallData")
	proto.RegisterType((*Result)(nil), "mage.profiles.v2.Result")
	proto.RegisterType((*Result_Success)(nil), "mage.profiles.v2.Result.Success")
	proto.RegisterType((*Result_Failed)(nil), "mage.profiles.v2.Result.Failed")
}

func init() {
	proto.RegisterFile("mage/profiles/v2/models_app_links.proto", fileDescriptor_c4a613de86d4edc0)
}
