...
// source: mage/profiles/v1beta1/models_profile.proto
...
// Profile represents a generic first on Mage, containing the information of a
// single user
type Profile struct {
...
func init() {
	proto.RegisterType((*Profile)(nil), "mage.profiles.v1beta1.Profile")
	proto.RegisterType((*Pictures)(nil), "mage.profiles.v1beta1.Pictures")
}

func init() {
	proto.RegisterFile("mage/profiles/v1beta1/models_profile.proto", fileDescriptor_a19232e029005b86)
}
