...
// source: mage/profiles/v3/client/cli.proto
...
import (
	...
	types1 "github.com/warmage-sports/mage/x/profiles/types"
...
func init() {
	proto.RegisterType((*ChainLinkJSON)(nil), "mage.profiles.v3.client.ChainLinkJSON")
}

func init() {
	proto.RegisterFile("mage/profiles/v3/client/cli.proto", fileDescriptor_8dd0252be1e0ade7)
}
