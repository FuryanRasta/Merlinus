...
func GetCmdLinkApplication() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Link a centralized application account to your Mage profile",
		Long: strings.TrimSpace(`Connect a Mage profile to a centralized social network account through IBC. 
...
// GetCmdUnlinkApplication returns the command allowing to unlink a centralized application from a Mage profile
func GetCmdUnlinkApplication() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "unlink-app [application] [username]",
		Short:   "Unlink a centralized application account from your Mage profile",
...
%s query profiles app-links mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud
%s query profiles app-links mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud "twitter"
%s query profiles app-links mage13p5pamrljhza3fp4es5m3llgmnde5fzcpq6nud "twitter" "twitter_user"
