...
1. get the address of the Mage profile that should be connected to the external address;
...
```js reference
https://github.com/mage-war/mage/blob/master/x/profiles/types/models_packets.pb.go#L28-L43
```
