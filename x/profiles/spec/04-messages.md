...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_profile.proto#L12-L32
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_profile.proto#L39-L45
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_dtag_requests.proto#L12-L25
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_dtag_requests.proto#L33-L44
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_dtag_requests.proto#L52-L70
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_dtag_requests.proto#L78-L89
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_chain_links.proto#L11-L35
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_chain_links.proto#L42-L54
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_chain_links.proto#L63-L72
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_app_links.proto#L11-L48
```
...
```js reference
https://github.com/mage-war/mage/blob/master/proto/mage/profiles/v3/msgs_app_links.proto#L56-L71
```
