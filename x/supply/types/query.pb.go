...
// source: mage/supply/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryTotalRequest)(nil), "mage.supply.v1.QueryTotalRequest")
	proto.RegisterType((*QueryTotalResponse)(nil), "mage.supply.v1.QueryTotalResponse")
	proto.RegisterType((*QueryCirculatingRequest)(nil), "mage.supply.v1.QueryCirculatingRequest")
	proto.RegisterType((*QueryCirculatingResponse)(nil), "mage.supply.v1.QueryCirculatingResponse")
}

func init() { proto.RegisterFile("mage/supply/v1/query.proto", fileDescriptor_821941a4adac8710) }
...
func (c *queryClient) Total(ctx context.Context, in *QueryTotalRequest, opts ...grpc.CallOption) (*QueryTotalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.supply.v1.Query/Total", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Circulating(ctx context.Context, in *QueryCirculatingRequest, opts ...grpc.CallOption) (*QueryCirculatingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.supply.v1.Query/Circulating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Total_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.supply.v1.Query/Total",
	}
...
func _Query_Circulating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.supply.v1.Query/Circulating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.supply.v1.Query",
	...
	Metadata: "mage/supply/v1/query.proto",
}
