...
replace (
	...
	// Our wasmd branch is: https://github.com/desmos-labs/wasmd v0.28.x-mage
	github.com/CosmWasm/wasmd => github.com/desmos-labs/wasmd v0.29.0-mage.2

	// Fixes Dragonberry
	github.com/confio/ics23/go => github.com/cosmos/cosmos-sdk/ics23/go v0.8.0

	// Our cosmos-sdk branch is: https://github.com/desmos-labs/cosmos-sdk v0.45.x-mage
	github.com/cosmos/cosmos-sdk => github.com/desmos-labs/cosmos-sdk v0.45.11-mage

	// Replace the Cosmos Ledger app with the Mage fork
	github.com/cosmos/ledger-cosmos-go => github.com/desmos-labs/ledger-mage-go v0.11.1-mage
