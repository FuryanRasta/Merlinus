...
service Query {
  ...
  rpc Reports(QueryReportsRequest) returns (QueryReportsResponse) {
    option (google.api.http).get = "/mage/reports/v1/{subspace_id}/reports";
  }
  ...
  rpc Reasons(QueryReasonsRequest) returns (QueryReasonsResponse) {
    option (google.api.http).get = "/mage/reports/v1/{subspace_id}/reasons";
  }
  
  // Params allows to query the module parameters
  rpc Params(QueryParamsRequest) returns (QueryParamsResponse) {
    option (google.api.http).get = "/mage/reports/v1/params";
  }
}
